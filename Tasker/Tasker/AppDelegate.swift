...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        /*var networkStatus = TaskerAPI.shared.checkConnectivity()
        if TaskerAPI.shared.checkConnectivity() == 2 {
            ...
            alert.addAction(UIAlertAction(title: "Retry", style: <#T##UIAlertAction.Style#>, handler: <#T##((UIAlertAction) -> Void)?##((UIAlertAction) -> Void)?##(UIAlertAction) -> Void#>))
        ...
        let mainController: MainController = storyboard.instantiateViewController(withIdentifier: "mainController") as! MainController
